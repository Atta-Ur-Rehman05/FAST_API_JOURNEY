    ...
    <div className="min-h-[75vh] flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md ui-surface rounded-sm p-6 sm:p-8 space-y-6 shadow-xs">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-xl font-bold text-[#212121]">Forgot Password</h1>
          <p className="text-xs text-[#757575]">Enter your account email and we will send reset instructions.</p>
        </div>
